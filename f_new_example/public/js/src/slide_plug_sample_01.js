...
const btn=$('.btn').find('button');
  ...
  const HorizonSlide =function(){productLi.eq(-1).clone().prependTo(productUl);
...
//세로형 슬라이드 기능 흐어어어어어ㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠㅠ
...
productUl.css({width:'100%', height:100*productLi+'%',
...
const ZIndexSlide=function(){productUl.css({'position':'relative', width:'100%'});
